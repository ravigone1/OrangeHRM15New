...
public class DataProviderSkills_Static {
 ...
 public void Static_Paramaters_test(String TestURL,String UserName,String Password,String Skill,String Skill_Desr) throws Exception    //step3 used to declare parameters in Method signature//
  {
	  ...
	  DataProviderSkills_Static.OpenChromeBroswer(TestURL);	  
	  DataProviderSkills_Static.login(UserName,Password);
	  DataProviderSkills_Static.Add_Skills(Skill,Skill_Desr);
	  DataProviderSkills_Static.closeBrowser();
	  ...
	  public  static void OpenChromeBroswer(String TestURL ) throws Exception{
	  ...
	  public  static void Add_Skills (String Skill1, String Skill_Desr1 ) throws Exception
	  {
