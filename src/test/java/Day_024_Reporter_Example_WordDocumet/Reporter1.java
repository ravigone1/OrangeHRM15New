package  Day_024_Reporter_Example_WordDocumet;
...
/*	@Test
	...
	*/
	...
	// C:\HTML Report\test-output\TempScreenShots\TC010_2020_Jun_16_9_02_37_881_PM
	 
	 System.out.println("TestName is123: "+TestName);
	 
	 
	 //Move image file to new destination
	 String fileWithPath= OutputFolder +"\\"+TestName+"_"+strDate +".png";
	 
	 System.out.println("fileWithPath is123: "+fileWithPath);
	...
	public String TakeScreenShotAuto(WebDriver driver,String Textmsg,String PassorFail) throws Exception
	{
	...
	// String fileWithPath= OutputFolder +"\\"+TestName+"\\"+strDate +".png";
	 ...
	 String fileWithPath= OutputFolder +"\\"+strDate +".png";
	 File DestFile=new File(fileWithPath);

	 
	 System.out.println("fileWithPath is123: "+TestName);
	 System.out.println("OutputFolder path is123: "+OutputFolder);
