...
public class Switch_by_Index_3 {
  ...
  public void Frames_Name() throws Exception {
	  ...
	  Switch_by_Index_3.Browser();
	  Switch_by_Index_3.GoogleFrame();
	  Switch_by_Index_3.AmazonFrame();	  
	  Switch_by_Index_3.GoogleFrame1();
	  Switch_by_Index_3.Close();
  }
