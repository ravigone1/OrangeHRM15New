...
public class Switch_by_WebElement_ref_2 {
  ...
  public void Frames_Name() throws Exception {
	  ...
	  Switch_by_WebElement_ref_2.Browser();
	  Switch_by_WebElement_ref_2.GoogleFrame();
	  Switch_by_WebElement_ref_2.AmazonFrame();	  
	  Switch_by_WebElement_ref_2.GoogleFrame1();
	  Switch_by_WebElement_ref_2.Close();
  }
