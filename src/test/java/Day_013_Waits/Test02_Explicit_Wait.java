...
public class Test02_Explicit_Wait {
  ...
  public static void Implicit() throws Exception {
	  ...
	  Test02_Explicit_Wait.openBrowser();
	  Test02_Explicit_Wait.openOrangeHRM();
	  Test02_Explicit_Wait.Login();
	  Test02_Explicit_Wait.AddLocations();
	  Test02_Explicit_Wait.Logout();
	  Test02_Explicit_Wait.CloseBrowser();
