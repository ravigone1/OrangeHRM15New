...
public class TC002_Return_Multiple_Values {
	...
	public  void page2(List<String> page_li) {
		...
		System.out.println(page_li);   //1st Model
		
		for(String str5:page_li)
		{  
			 System.out.println("The value is " +str5);   //2nd model
		}  
		
		
		   System.out.println(" Element data 0  :  " + page_li.get(0)); //3rd model
